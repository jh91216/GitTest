...
<div class="search_boxes">
	<div class="search_box">
		<select name="" id="" onchange="categoryChange(this)">
		 ...
		 <option value="general02">부산</option>
		 <option value="general03">인천</option>
		 <option value="general04">대구</option>
		 <option value="general05">울산</option>
		 <option value="general06">광주</option>
		 <option value="general07">대전</option>
		 <option value="general08">강원</option>
		 <option value="general09">경기</option>
		 <option value="general10">경남</option>
		 <option value="general11">경북</option>
